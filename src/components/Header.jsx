...
if(openNavigation){
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8/90 lg:bg-backdrop-blur-sm lg:border-n-6 ${openNavigation ? "bg-n-8" : "bg-n-8/90 backdrop-blur-sm"}`}>
